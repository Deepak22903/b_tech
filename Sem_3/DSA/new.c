...
// Function to print the resultant matrix in matrix form
...
// Function to subtract two matrices represented as linked lists
...
int main() {
    ...
    // Call the addMatrices function to get the result linked list for addition
    Node* sumResult = addMatrices(matrix1, matrix2, numRows1, numCols1);

    // Call the subtractMatrices function to get the result linked list for subtraction
    Node* diffResult = subtractMatrices(matrix1, matrix2, numRows1, numCols1);

    // Write the result of addition to MatrixSum.txt
    writeMatrixToFile("MatrixSum.txt", sumResult, numRows1, numCols1);

    // Write the result of subtraction to MatrixDiff.txt
    writeMatrixToFile("MatrixDiff.txt", diffResult, numRows1, numCols1);

    // Clean up memory for matrices and results if needed
